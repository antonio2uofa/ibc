...
"""
Streaming metrics keep track of the last (upto) K values of the metric in a Deque buffer of size K. 
Calling result() will return the average value of the items in the buffer. 

It stands for "double-ended queue," and it allows for efficient appending and popping of elements from both ends (left and right) of the queue.
"""
